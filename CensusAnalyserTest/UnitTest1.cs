using Day29_Indian_States_Census_analyser;
using Day29_Indian_States_Census_analyser.DTO;
using NUnit.Framework;
using System.Collections.Generic;
using static Day29_Indian_States_Census_analyser.CensusAnalyzer;
...
namespace CensusAnalyserTest
{
    public class UnitTests
    {
        ...
        static string indianStateCensusFilePath = @"E:\c# git push\Day29_Indian_States_Census_analyser\Day29_Indian_States_Census_analyser\CSVFiles\IndiaStateCensusData.csv";
        static string wrongHeaderIndianCensusFilePath = @"E:\c# git push\Day29_Indian_States_Census_analyser\Day29_Indian_States_Census_analyser\CSVFiles\WrongIndiaStateCensusData.csv";
        static string delimeterIndianCensusFilePath = @"E:\c# git push\Day29_Indian_States_Census_analyser\Day29_Indian_States_Census_analyser\CSVFiles\DelimiterIndiaStateCensusData.csv";
        static string wrongIndianStateCensusFilePath = @"E:\c# git push\Day29_Indian_States_Census_analyser\Day29_Indian_States_Census_analyser\CSVFiles\WrongIndiaStateCensusData.csv";
        static string wrongIndianCensusFileType = @"E:\c# git push\Day29_Indian_States_Census_analyser\Day29_Indian_States_Census_analyser\CSVFiles\IndiaStateCensusData.txt";

        static string indianStateCodeFilePath = @"E:\c# git push\Day29_Indian_States_Census_analyser\Day29_Indian_States_Census_analyser\CSVFiles\IndiaStateCode.csv";
        static string wrongIndianStateCodeFileType = @"E:\c# git push\Day29_Indian_States_Census_analyser\Day29_Indian_States_Census_analyser\CSVFiles\IndiaStateCode.txt";
        static string delimeterIndianStateCodeFilePath = @"E:\c# git push\Day29_Indian_States_Census_analyser\Day29_Indian_States_Census_analyser\CSVFiles\DelimiterIndiaStateCode.csv";
        static string wrongHeaderStateCodeFilePath = @"E:\c# git push\Day29_Indian_States_Census_analyser\Day29_Indian_States_Census_analyser\CSVFiles\WrongIndiaStateCode.csv";

        Day29_Indian_States_Census_analyser.CensusAnalyzer censusAnalyzer;
